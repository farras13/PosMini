...
<head>
	...
	<title>Majoo Telekomunikasi Indonesia</title>
...
<body>
	<section class="Form my-4 mx-5">
		<div class="container">
			<div class="row g-0">
				<div class="col-lg-6">
					<img src="<?= base_url('assets/img/majoo_logo.png') ?>" height="auto" width="auto" class="img-fluid" alt="">
				</div>
				<div class="kolom col-lg-6 px-5 py-5">
					<h1 class="font-weight-bold pt-5">Login Admin </h1>
